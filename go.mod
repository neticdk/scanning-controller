module github.com/neticdk/scanning-controller
...
require (
	...
	github.com/bxcodec/gotcha v1.0.0-beta.3 // indirect
	...
	github.com/openshift/api v0.0.0-20231025170628-b8a18fdc040d // indirect
